...
class CurrentWeather(Resource):
    ...
    def get(self):
        ...
        twenty_four_hour_temp = get_hourly_data(43.1163, -75.4037)

        return {'twentyFourHourTemp': predict_hourly_weather(twenty_four_hour_temp), 'datasetLength': len(twenty_four_hour_temp)}
